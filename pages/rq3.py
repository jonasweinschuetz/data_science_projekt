...
df = pd.read_csv('C:/Users/Micro/Desktop/git_projekte/git-hub/data_science_projekt/data/german-canteens(filtered).csv', sep='@', engine='python')
# Load your data
...
with open('C:/Users/Micro/Desktop/git_projekte/git-hub/data_science_projekt/data/deutschland_updated.geo.json', 'r', encoding='utf8') as file:
