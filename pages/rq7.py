...
# Load the data
meals_df = pd.read_csv('C:/Users/Micro/Desktop/git_projekte/git-hub/data_science_projekt/data/german-canteens(filtered).csv', sep='@', encoding='utf8')
# Load geo data
with open('C:/Users/Micro/Desktop/git_projekte/git-hub/data_science_projekt/data/further_updated_german_canteens.json', 'r', encoding='utf-8') as file:
    geo_data = json.load(file)
# Load your data
csv_path = 'C:/Users/Micro/Desktop/git_projekte/git-hub/data_science_projekt/data/german-canteens(filtered).csv'
df = pd.read_csv(csv_path, sep='@', encoding='utf8')
# Load JSON data and merge
json_path = 'C:/Users/Micro/Desktop/git_projekte/git-hub/data_science_projekt/data/further_updated_german_canteens.json'
